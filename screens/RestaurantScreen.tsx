...
import { IDish, IRestaurant } from '../type';
    ...
    <ScrollView>
        ...
        <View className='pb-36'>
            ...
            {dishes && dishes.map((dish: IDish) => (
                <DishRow key={dish._id} _id={dish._id} name={dish.name} short_description={dish.short_description} price={dish.price} image={dish.image}/>
                ))}
        </View>
    </ScrollView>
    </>
